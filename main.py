...
button = Button(frame, text="Add", font="arial 20 bold", width=6, bg="lightgray", fg="#fff", bd=0, command=addTask)
button.place(x=236, y=0)

frame1 = Frame(root, bd=3, width = 260, height = 250, bg = "black")
frame1.pack(pady=(50,0))

listbox = Listbox(frame1, font=('arial', 12), width = 37, height = 16, bg = "lightgray", fg="black", cursor="hand2", selectbackground="gray")
...
Button(root, image=Delete_icon, bd = 0, command=deleteTask).place(x=140, y=520)
